...
const en = {
  ...
  bulkArchiveTools: "Bulk archive controls",
  archived: "Archived",
  confirmArchive: "Move this visit to the archive?",
  confirmArchiveSelected: "Archive {count} selected visits?",
  selectAll: "Select all",
  clearSelection: "Clear selection",
  selectedVisits: "selected",
  selectVisit: "Select visit with {name}",
  phone: "Phone number",
...
const uk: typeof en = {
  ...
  archiveSelected: "Архівувати вибрані",
  bulkArchiveTools: "Керування масовим архівуванням",
  archived: "В архіві",
  confirmArchive: "Перемістити це відвідування до архіву?",
  confirmArchiveSelected: "Архівувати вибрані відвідування ({count})?",
  selectAll: "Вибрати всі",
  clearSelection: "Очистити вибір",
  selectedVisits: "вибрано",
  selectVisit: "Вибрати відвідування: {name}",
