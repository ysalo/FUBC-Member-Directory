  ...
  return (
    ...
    >
      <button
        ...
        className={`${variant === "flags" ? "grid size-11 place-items-center rounded-lg" : "min-h-11 min-w-11 rounded-lg px-2 text-sm font-semibold"} ${locale === "en" ? "bg-[var(--app-surface)] text-[var(--app-ink)] shadow-sm" : "text-[var(--app-muted)]"}`}
      >
        {variant === "flags" ? <svg aria-hidden="true" viewBox="0 0 60 40" className="h-4 w-6 overflow-hidden rounded-[2px]">
      ...
      <button
        ...
        className={`${variant === "flags" ? "grid size-11 place-items-center rounded-lg" : "min-h-11 min-w-11 rounded-lg px-2 text-sm font-semibold"} ${locale === "uk" ? "bg-[var(--app-surface)] text-[var(--app-ink)] shadow-sm" : "text-[var(--app-muted)]"}`}
      >
        {variant === "flags" ? <svg aria-hidden="true" viewBox="0 0 60 40" className="h-4 w-6 overflow-hidden rounded-[2px]">
