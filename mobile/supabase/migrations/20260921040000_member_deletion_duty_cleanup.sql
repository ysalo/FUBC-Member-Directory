...
-- Duty assignments are regenerated from the current deacon list. Remove a
-- departing member's assignments before deleting the directory record.
...
begin
  ...
  delete from public.deacon_duty_periods where person_id=p_person_id;
