...
export const groupsCopy = {
  en: {
    title: "Groups", search: "Search groups", searchMembers: "Search members", myGroup: "My group", otherGroups: "Other groups", allGroups: "All groups", openGroup: "Opens the group roster",
    members: "Members", responsibleDeacons: "Responsible deacons", noDeacons: "No deacons", birthdays: "Next 7 days", birthdayNotifications: "Birthday notifications", birthdayNotificationDetail: "On the birthday at 9:00 AM PDT", noUpcomingBirthdays: "No birthdays in the next seven days.", notificationError: "Birthday notifications could not be updated.", summary: (total: number, orphans: number, widows: number) => `${total} members · ${orphans} orphans · ${widows} widows`,
