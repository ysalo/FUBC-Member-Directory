...
export function GroupAssignmentScreen() {
  ...
  const moves = useMemo(() => data?.deacons.filter((deacon) => selected.includes(deacon.personId) && deacon.currentGroupId && deacon.currentGroupId !== groupId) ?? [], [data, groupId, selected]);
