...
const translations = {
  en: {
    tabs: { directory: "Directory", groups: "Groups", visitation: "Visitation", manage: "Manage", menu: "Menu" },
    directory: {
  ...
  uk: {
    tabs: { directory: "Довідник", groups: "Групи", visitation: "Відвідування", manage: "Керування", menu: "Меню" },
    directory: {
